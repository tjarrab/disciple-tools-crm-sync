...
// --- multi-line reassembly (the core bug fix) ---
    ...
    public function test_continuation_line_is_joined_into_same_bubble(): void {
        ...
        $log = implode( "\n", [
            ...
            'https://bitenaama.com/bible/aeb-aeb2-mat-5/ [Translation: Very good! You can start from here:',
            'https://bitenaama.com/bible/aeb-aeb2-mat-5/]',
        ] );
        ...
        $this->assertStringContainsString( 'bitenaama.com', $html, 'URL must appear inside the bubble.' );
    ...
    public function test_second_multi_line_example_from_bug_report(): void {
        ...
        $log = implode( "\n", [
            '[2025-02-27, Thursday, 07:56:00 UTC] Agent: إي نعم، تنجم تبدا من هنا: https://bitenaama.com/bible/aeb-aeb2-mat-5/',
            'تحب نعاونك تلقى فصل معيّن؟ [Translation: Yes, you can start from here: https://bitenaama.com/bible/aeb-aeb2-mat-5/',
